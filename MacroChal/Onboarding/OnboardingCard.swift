...
var Data:[OnboardingCard] = [
    OnboardingCard(image: "OnboardingForRest", title: "Welcome to", subtitle: "Boo ForRest!", text: "This is a safe place where you can learn to love yourself more by deepening your connection with yourselves. With ForRest, you are guided to do self-dialogue, to come back to your inner state which is: calm, safe and comfy."),
